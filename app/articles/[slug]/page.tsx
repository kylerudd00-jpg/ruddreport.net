    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-link { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #3d5870; text-decoration: none; text-transform: uppercase; display: inline-block; margin-bottom: 32px; transition: color 0.3s; }
        .back-link:hover { color: #1e9eff; }
        .article-meta { display: flex; align-items: center; gap: 14px; margin-bottom: 24px; flex-wrap: wrap; }
        .meta-category { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #1e9eff; border: 1px solid rgba(30,158,255,0.3); padding: 3px 10px; text-transform: uppercase; }
        .meta-date { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #3d5870; }
        .meta-time { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #3d5870; }
        ...
        /* SHARE + FOOTER */
        .article-sign-off { margin-top: 60px; padding-top: 40px; border-top: 1px solid rgba(30,158,255,0.12); font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; }

        /* RELATED ARTICLES */
        .related { max-width: 1200px; margin: 0 auto; padding: 60px 40px 100px; border-top: 1px solid rgba(30,158,255,0.08); }
        .related-label { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 4px; color: #3d5870; text-transform: uppercase; margin-bottom: 28px; display: flex; align-items: center; gap: 12px; }
        ...
        .related-card-cat { font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 3px; color: #1e9eff; text-transform: uppercase; }
        .related-card-date { font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 2px; color: #3d5870; }
        ...
        .toc-label { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; margin-bottom: 16px; padding-bottom: 12px; border-bottom: 1px solid rgba(30,158,255,0.12); }
        .toc-list { list-style: none; display: flex; flex-direction: column; gap: 2px; }
        .toc-item a { display: block; font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 1px; color: #3d5870; text-decoration: none; padding: 6px 0 6px 12px; border-left: 1px solid rgba(30,158,255,0.1); transition: all 0.2s; line-height: 1.5; }
