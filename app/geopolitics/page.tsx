    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-status { display: flex; align-items: center; gap: 8px; font-family: 'IBM Plex Mono', monospace; font-size: 10px; color: #3d5870; letter-spacing: 2px; }
        ...
        .hero-tagline { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 5px; color: #1e9eff; text-transform: uppercase; margin-bottom: 28px; }
        ...
        .articles-label { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 5px; color: #1e9eff; text-transform: uppercase; margin-bottom: 8px; }
        ...
        .card-category { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; text-transform: uppercase; color: #1e9eff; border: 1px solid #0d5a9e; padding: 3px 10px; background: rgba(30,158,255,0.08); }
        .card-date { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #3d5870; }
        ...
        .card-read { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #1e9eff; text-transform: uppercase; }
        .threat-high { color: #ff3a3a; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; }
        .threat-med { color: #ffaa00; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; }
        .threat-low { color: #1e9eff; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; }
        .coming-soon { text-align: center; padding: 60px 40px; border: 1px dashed rgba(30,158,255,0.2); margin-top: 2px; }
        .coming-soon-text { font-family: 'IBM Plex Mono', monospace; font-size: 11px; letter-spacing: 4px; color: #3d5870; text-transform: uppercase; }
