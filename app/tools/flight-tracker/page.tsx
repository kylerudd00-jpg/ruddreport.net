    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-stat-label { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        ...
        .tab-btn { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; text-transform: uppercase; padding: 12px 24px; background: none; border: none; color: #5a7a94; cursor: pointer; border-bottom: 2px solid transparent; transition: all 0.2s; position: relative; bottom: -1px; }
        ...
        .countdown-tag { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 2px; color: #5a7a94; white-space: nowrap; }

        /* Airport search */
        .airport-controls { display: flex; gap: 10px; align-items: center; margin-bottom: 16px; flex-wrap: wrap; }
        .airport-hint { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; text-transform: uppercase; margin-bottom: 12px; }
        ...
        .airport-results-title { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #5a7a94; text-transform: uppercase; }
        ...
        .flight-col-label { font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        ...
        .flight-icao { font-family: 'IBM Plex Mono', monospace; font-size: 9px; color: #5a7a94; margin-top: 2px; }
        ...
        .flight-col-header > div { padding: 8px 16px; font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        ...
        .airport-empty-text { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; line-height: 2; }
        .airport-loading { display: flex; align-items: center; justify-content: center; padding: 60px 20px; font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; animation: pulse 1.5s infinite; }
        ...
        .ap-no-selection-text { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; line-height: 1.8; }
        ...
        .lookup-photo-credit { position: absolute; bottom: 0; left: 0; right: 0; padding: 6px 10px; background: rgba(3,6,8,0.8); font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 2px; color: #5a7a94; text-transform: uppercase; }
        .lookup-photo-none { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        ...
        .lookup-not-found-text { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; line-height: 2; }
        .lookup-hint { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; text-transform: uppercase; margin-bottom: 14px; }
        .lookup-examples { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 20px; }
        .lookup-example { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; border: 1px solid rgba(30,158,255,0.1); padding: 4px 10px; cursor: pointer; transition: all 0.15s; text-transform: uppercase; }
        ...
        .map-loading-text { font-family: 'IBM Plex Mono', monospace; font-size: 11px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        ...
        .info-icao { font-family: 'IBM Plex Mono', monospace; font-size: 11px; color: #5a7a94; margin-top: 4px; letter-spacing: 2px; }
        ...
        .field-label { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; margin-bottom: 4px; }
        ...
        .loading-row { padding: 14px 20px; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; animation: pulse 1.5s infinite; }
        ...
        .route-city { font-family: 'IBM Plex Mono', monospace; font-size: 9px; color: #5a7a94; letter-spacing: 1px; }
        .route-arrow { display: flex; align-items: center; justify-content: center; padding: 12px 20px; font-family: 'IBM Plex Mono', monospace; font-size: 16px; color: #5a7a94; border-bottom: 1px solid rgba(30,158,255,0.05); }
        ...
        .no-selection-text { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; line-height: 1.8; }
        ...
        .cat-btn { display: flex; align-items: center; gap: 7px; padding: 6px 14px; background: rgba(10,21,32,0.8); border: 1px solid rgba(30,158,255,0.15); font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; text-transform: uppercase; color: #5a7a94; cursor: pointer; transition: all 0.2s; white-space: nowrap; }
        ...
        .legend-item { display: flex; align-items: center; gap: 8px; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; text-transform: uppercase; }
        .legend-dot { width: 8px; height: 8px; border-radius: 50%; }
        .credit { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; margin-top: 8px; }
                  ...
                  {airportFlights.length > 0 && (
                    <>
                      ...
                      <div style={{display:'flex', gap:'6px', padding:'8px 16px', borderBottom:'1px solid rgba(30,158,255,0.08)', alignItems:'center'}}>
                        <span style={{fontFamily:"'IBM Plex Mono', monospace", fontSize:'8px', letterSpacing:'3px', color:'#5a7a94', textTransform:'uppercase', marginRight:'4px'}}>Sort:</span>
