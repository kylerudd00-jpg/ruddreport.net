...
const STYLE = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  textarea { width: 100%; background: rgba(3,6,8,0.8); border: 1px solid rgba(30,158,255,0.15); color: #d8e8f5; font-family: 'Share Tech Mono', monospace; font-size: 12px; padding: 14px; outline: none; resize: vertical; min-height: 100px; line-height: 1.6; transition: border-color 0.2s; }
  ...
  .jwt-json { font-family: 'Share Tech Mono', monospace; font-size: 12px; line-height: 1.8; white-space: pre-wrap; word-break: break-all; }
  .jwt-sig { background: #0a1520; border: 1px solid rgba(30,158,255,0.12); padding: 24px; margin-top: 2px; }
  .sig-val { font-family: 'Share Tech Mono', monospace; font-size: 11px; color: #5a7a94; word-break: break-all; margin-top: 8px; }
  ...
  .claim-val { font-family: 'Share Tech Mono', monospace; font-size: 13px; color: #9ab0c4; }
