    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .date-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; text-transform: uppercase; }
        .year-input { background: rgba(10,21,32,0.8); border: 1px solid rgba(30,158,255,0.2); color: #c0cfe0; font-family: 'Share Tech Mono', monospace; font-size: 12px; padding: 6px 12px; width: 120px; outline: none; letter-spacing: 1px; }
        .year-input::placeholder { color: #5a7a94; }
        .year-input:focus { border-color: rgba(30,158,255,0.5); }
        .date-sep { color: #5a7a94; font-family: 'Share Tech Mono', monospace; font-size: 11px; }
        .date-clear { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #5a7a94; background: none; border: none; cursor: pointer; text-transform: uppercase; padding: 0; transition: color 0.2s; }
        .date-clear:hover { color: #1e9eff; }
        .results { max-width: 1000px; margin: 0 auto; padding: 0 40px 80px; }
        .result-header { margin-bottom: 20px; }
        .result-meta { font-family: 'Share Tech Mono', monospace; font-size: 11px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        .result-meta span { color: #1e9eff; }
        .snapshot-table { width: 100%; border-collapse: collapse; }
        .snapshot-table th { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #5a7a94; text-transform: uppercase; padding: 12px 16px; text-align: left; border-bottom: 1px solid rgba(30,158,255,0.12); background: rgba(30,158,255,0.03); }
        ...
        .info-box { background: rgba(30,158,255,0.04); border: 1px solid rgba(30,158,255,0.15); padding: 16px 20px; margin-bottom: 24px; font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 2px; color: #5a7a94; line-height: 1.8; }
