      ...
      <div className="page-wrap">
        ...
        <div className="tool-hero">
          <div className="tool-hero-inner">
            ...
            <p className="tool-desc">Decode any 17-character Vehicle Identification Number using the NHTSA database. Find the make, model, year, engine, trim, drive type, and country of manufacture — free, no account needed. Useful before buying a used car.</p>
          </div>
        </div>
        ...
        <div className="main-wrap">
          ...
          <div className="info-box">
            ...
            <div className="info-text">The VIN is printed on the driver&apos;s side dashboard (visible through the windshield), on the door jamb sticker, on the title, and on the insurance card. It is always exactly 17 characters. Data is sourced from the NHTSA vPIC API and reflects manufacturer specifications — not accident history or title status.</div>
          </div>
        </div>
