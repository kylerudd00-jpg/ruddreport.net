    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mode-tab { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 3px; text-transform: uppercase; padding: 10px 20px; border: 1px solid rgba(30,158,255,0.2); background: none; color: #5a7a94; cursor: pointer; transition: all 0.2s; }
        ...
        .mode-note { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 2px; color: #5a7a94; margin-top: 12px; line-height: 1.7; }
        ...
        .match-bits { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #5a7a94; border: 1px solid rgba(30,158,255,0.15); padding: 4px 12px; }
        ...
        .breach-note { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 2px; color: #5a7a94; line-height: 1.8; margin-top: 16px; }
        .input-preview { font-family: 'Share Tech Mono', monospace; font-size: 11px; letter-spacing: 2px; color: #5a7a94; margin-bottom: 20px; word-break: break-all; }
        ...
        .section-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #5a7a94; text-transform: uppercase; margin-bottom: 16px; }
