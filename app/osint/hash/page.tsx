    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-preview { font-family: 'Share Tech Mono', monospace; font-size: 11px; letter-spacing: 2px; color: #3d5870; margin-bottom: 20px; word-break: break-all; }
        ...
        .section-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #3d5870; text-transform: uppercase; margin-bottom: 16px; }
