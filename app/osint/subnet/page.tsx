...
const STYLE = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cidr-input { flex: 1; background: rgba(3,6,8,0.8); border: 1px solid rgba(30,158,255,0.2); color: #d8e8f5; font-family: 'Share Tech Mono', monospace; font-size: 16px; padding: 14px 18px; outline: none; transition: border-color 0.2s; letter-spacing: 1px; }
  ...
  .result-cell-val { font-family: 'Share Tech Mono', monospace; font-size: 15px; color: #c0cfe0; }
  ...
  .quick-btn { font-family: 'Share Tech Mono', monospace; font-size: 11px; color: #5a7a94; background: #0a1520; border: 1px solid rgba(30,158,255,0.1); padding: 5px 12px; cursor: pointer; transition: all 0.2s; }
