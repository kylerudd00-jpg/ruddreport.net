    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-label { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 4px; color: #3d5870; text-transform: uppercase; margin-bottom: 12px; }
        ...
        .section-label { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 4px; color: #3d5870; text-transform: uppercase; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 1px solid rgba(30,158,255,0.08); }
        ...
        .auth-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; margin-bottom: 8px; }
        .auth-value { font-family: 'Orbitron', monospace; font-size: 18px; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; }
        ...
        .summary-key { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; margin-bottom: 4px; }
        ...
        .hop-num { font-family: 'Orbitron', monospace; font-size: 13px; font-weight: 700; color: #3d5870; }
        ...
        .hop-ts { font-family: 'Share Tech Mono', monospace; font-size: 9px; color: #3d5870; }
      ...
      <div className="page-wrap">
        ...
        {analyzed && (
          <div className="results-wrap">
            ...
            {hops.length === 0 && (
              <div style={{fontFamily: "'Share Tech Mono', monospace", fontSize: '11px', letterSpacing: '2px', color: '#3d5870'}}>
