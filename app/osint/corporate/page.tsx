    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .panel-header { padding: 12px 16px; border-bottom: 1px solid rgba(255,170,0,0.08); font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; position: sticky; top: 0; background: #0a1520; z-index: 1; }
        ...
        .ri-meta { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 1px; color: #3d5870; }
        ...
        .graph-empty-text { font-family: 'IBM Plex Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; }
        ...
        .legend-row { display: flex; align-items: center; gap: 8px; font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 1px; color: #3d5870; text-transform: uppercase; }
        ...
        .detail-empty { padding: 32px 16px; font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 2px; color: #3d5870; text-align: center; line-height: 2.5; }
        ...
        .detail-lei { font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 1px; color: #3d5870; word-break: break-all; }
        .detail-field { padding: 9px 16px; border-bottom: 1px solid rgba(30,158,255,0.04); }
        .df-label { font-family: 'IBM Plex Mono', monospace; font-size: 8px; letter-spacing: 3px; color: #3d5870; text-transform: uppercase; margin-bottom: 4px; }
