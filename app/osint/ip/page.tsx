    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; margin-bottom: 8px; }
        ...
        <div className="search-wrap">
          ...
          {history.length > 0 && (
            <div style={{ marginTop: '16px', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '9px', letterSpacing: '2px', color: '#5a7a94', textTransform: 'uppercase' }}>Recent:</span>
              {history.map(h => (
                <button key={h} onClick={() => { setIp(h); lookup(h); }}
                  style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '10px', color: '#7a9bb5', background: 'rgba(30,158,255,0.06)', border: '1px solid rgba(30,158,255,0.15)', padding: '3px 10px', cursor: 'pointer', transition: 'all 0.2s', letterSpacing: '1px' }}
