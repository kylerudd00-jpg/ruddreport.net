    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-bar { max-width: 1100px; margin: 24px auto; padding: 16px 24px; background: rgba(255,60,60,0.08); border: 1px solid rgba(255,60,60,0.2); font-family: 'IBM Plex Mono', monospace; font-size: 12px; color: #ff6060; letter-spacing: 2px; }
