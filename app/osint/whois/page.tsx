            ...
            <div style={{ marginTop: '12px', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {history.map(h => (
                <button key={h} onClick={() => { setDomain(h); runLookup(h); }}
                  style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '10px', color: '#7a9bb5', background: 'rgba(30,158,255,0.06)', border: '1px solid rgba(30,158,255,0.15)', padding: '3px 10px', cursor: 'pointer', letterSpacing: '1px' }}
