    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .result-domain { font-family: 'Barlow Condensed', sans-serif; font-size: 22px; font-weight: 700; color: #1e9eff; letter-spacing: 2px; }
        ...
        .section-title { font-family: 'IBM Plex Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #1e9eff; text-transform: uppercase; padding: 16px 28px 12px; background: rgba(30,158,255,0.03); border-bottom: 1px solid rgba(30,158,255,0.06); }
        ...
        .status-item { font-family: 'IBM Plex Mono', monospace; font-size: 11px; color: #7a9bb5; letter-spacing: 1px; }
