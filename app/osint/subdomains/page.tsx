    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .results-meta { font-family: 'Share Tech Mono', monospace; font-size: 11px; letter-spacing: 3px; color: #5a7a94; text-transform: uppercase; }
        .results-meta span { color: #1e9eff; }
        .results-actions { display: flex; gap: 8px; align-items: center; flex-wrap: wrap; }
        .filter-box { background: #0a1520; border: 1px solid rgba(30,158,255,0.2); padding: 10px 14px; font-family: 'Share Tech Mono', monospace; font-size: 12px; color: #d8e8f5; letter-spacing: 1px; outline: none; width: 240px; }
        .filter-box::placeholder { color: #5a7a94; }
        .copy-btn { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 3px; color: #5a7a94; background: none; border: 1px solid rgba(30,158,255,0.15); padding: 10px 18px; cursor: pointer; text-transform: uppercase; transition: all 0.3s; white-space: nowrap; }
        ...
        .subdomain-table th { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #5a7a94; text-transform: uppercase; padding: 12px 16px; text-align: left; border-bottom: 1px solid rgba(30,158,255,0.12); background: rgba(30,158,255,0.03); }
