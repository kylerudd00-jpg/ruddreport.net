    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .intel-label { font-family: 'Share Tech Mono', monospace; font-size: 9px; letter-spacing: 4px; color: #5a7a94; text-transform: uppercase; margin-bottom: 12px; }
        ...
        .record-count { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 2px; color: #5a7a94; }
        ...
        .record-name { font-family: 'Share Tech Mono', monospace; font-size: 10px; color: #5a7a94; letter-spacing: 1px; word-break: break-all; }
        .record-ttl { font-family: 'Share Tech Mono', monospace; font-size: 10px; color: #5a7a94; }
        ...
        .raw-label { font-family: 'Share Tech Mono', monospace; font-size: 10px; color: #5a7a94; margin-bottom: 8px; word-break: break-all; letter-spacing: 1px; }
                ...
                <div className="intel-grid">
                  ...
                  {!result.intelligence.emailProvider && !result.intelligence.dnsProvider && result.intelligence.services.length === 0 && !result.intelligence.spfDecoded && !result.intelligence.dmarcDecoded && (
                    <div className="intel-card full">
                      ...
                      <div style={{fontFamily:'Share Tech Mono', fontSize:'11px', color:'#5a7a94', letterSpacing:'2px'}}>Limited intelligence available. Check Raw Records tab.</div>
                    </div>
                  )}
                </div>
              )}
