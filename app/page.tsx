  ...
  return (
    <>
      <style>{`
        ...
        .nav-logo-text { font-family: 'Orbitron', monospace; font-size: 13px; font-weight: 700; letter-spacing: 3px; color: var(--silver); text-transform: uppercase; line-height: 1.2; }
        ...
        .nav-links a { font-family: 'Barlow Condensed', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 3px; text-transform: uppercase; color: var(--text-secondary); text-decoration: none; transition: color 0.3s; position: relative; }
        ...
        .hero-title { font-family: 'Orbitron', monospace; font-size: clamp(48px, 8vw, 96px); font-weight: 900; line-height: 0.95; color: var(--silver); text-transform: uppercase; letter-spacing: -2px; opacity: 0; animation: fadeUp 0.9s ease 0.5s forwards; }
